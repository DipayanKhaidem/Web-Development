...
const features=[
    ...
    description:"Intelligent code suggestions powered by advanced AI that learns from your patterns.Get real-time assistance with syntax,logic, and best practices",
  ...
  // Auto-completed by AI
    ...
    description:"Generate comprehensive test suites automatically. Our AI analyzes your code and creates unit tests,integration test,and edge case coverage.",
  ...
  it("should login successfully", () => {
    ...
    description:"Identify and fix bugs before they reach production. AI-powered error detection and resolution suggestion help you debug faster",
                    ...
                    <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition==="right"?"lg:flex-row-reverse":""}`}>
                        ...
                        <div className="flex-1 w-full">
                            <div className="relative group">
                                ...
                                sm:rounded-2xl transition-all duration-500" />
